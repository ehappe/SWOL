...
public class ACRAFeedbackMailer implements ReportSender {
	...
	private final static String BASE_URL = "http://skubware.de/de.skubware.opentraining/acra_feedback.php";
	...
	public void send(Context c, CrashReportData report) throws ReportSenderException {
		...
		try {
			...
			String custom_data = report.getString(ReportField.CUSTOM_DATA); // custom data has to be split
	        ...
	        //ACRA.getErrorReporter().(new ACRACrashReportMailer());
