...
package com.shredware.swol.activity.manage_workouts;
 ...
 * selections.
 */
public class WorkoutListActivity extends AppCompatActivity implements WorkoutListFragment.Callbacks {
	/** Tag for logging */
